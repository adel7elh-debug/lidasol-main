  ...
  return (
    <footer className="site-footer">
      <div className="container footer-main">
        ...
        <div><strong>Services</strong><Link href="/digitalisation">Digitalisation & automatisation</Link><Link href="/conseil-accompagnement">Conseil & accompagnement</Link><Link href="/gestion-organisation">Pilotage & organisation</Link><Link href="/formation">Formations professionnelles</Link></div>
        <div><strong>Formations</strong><Link href="/formation/gestion-administrative-comptable">Gestion administrative & comptable</Link><Link href="/formation/gestion-intelligence-artificielle">IA appliquée à l’entreprise</Link><Link href="/formation/qhse">ISO & QSE</Link><Link href="/formation/excel">Excel & analyse des données</Link></div>
