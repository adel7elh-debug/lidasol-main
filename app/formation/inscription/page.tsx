...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Inscription formation LIDA", description: "Préparez votre demande de formation professionnelle avec LIDA.", url: "/formation/inscription", images: [{ url: "/photos/formation.jpg", alt: "Inscription à une formation LIDA" }] },
};
...
export default async function TrainingRegistrationPage({ searchParams }: Props) {
  ...
  return (
    <main>
      <PageHero eyebrow="Inscription" title="Préparez votre demande de formation." description="Précisez votre besoin, votre niveau et le format souhaité. Vous pourrez ensuite transmettre la demande complète sur WhatsApp." image="/photos/formation.jpg" imageAlt="Inscription à une formation LIDA" breadcrumbs={[{ label: "Formations", href: "/formation" }, { label: "Inscription", href: "/formation/inscription" }]} primaryLabel="Voir le catalogue" primaryHref="/formation" whatsappMessage={whatsappMessages.formation} />
