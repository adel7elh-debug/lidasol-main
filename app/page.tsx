...
export default function Home() {
  return (
    <main>
      ...
      <section className="section training-preview light-section"><div className="container"><div className="section-heading split-heading"><div><p className="eyebrow eyebrow-dark"><span /> Formations</p><h2>Développer des compétences directement applicables.</h2></div><p>Quatre axes pratiques, en présentiel, à distance ou en intra-entreprise, adaptés au niveau et aux besoins de vos équipes.</p></div><div className="featured-trainings"><Link href="/formation/gestion-administrative-comptable"><small>Gestion</small><h3>Gestion administrative & comptable</h3><span>Voir les formations <ArrowRight aria-hidden="true" size={16} /></span></Link><Link href="/formation/gestion-intelligence-artificielle"><small>Innovation</small><h3>IA appliquée à l’entreprise</h3><span>Voir les formations <ArrowRight aria-hidden="true" size={16} /></span></Link><Link href="/formation/qhse"><small>Management</small><h3>ISO & QSE</h3><span>Voir les formations <ArrowRight aria-hidden="true" size={16} /></span></Link><Link href="/formation/excel"><small>Données</small><h3>Excel & analyse des données</h3><span>Voir les formations <ArrowRight aria-hidden="true" size={16} /></span></Link></div><div className="center-action"><Link className="button button-blue" href="/formation">Voir toutes les formations</Link></div></div></section>
